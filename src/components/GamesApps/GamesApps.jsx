      ...
      <section className="section section-gameapps" id="gameapps">
        ...
        <div className="game">
          <div className="game-info">
            <p className="game-name">
              Reptilian game{" "}
              <span className="game-version">ver 2.0 released</span>
            </p>
            <p className="game-description">
              Try playing the other way!
              <br />
              What happens when you combine the dynamics of "bullet hell" style,
              energetic music, pixel art, and a look at the classic game from a
              different angle?
              <br />
              Reptilian!
              <br />
              ...
              your game strategy from thousands of possible variations!
              <br />
        ...
        <div className="game">
          <div className="game-info">
            ...
            <p className="game-description">
              ...
              keep our style, and add more color and cute.
              <br />
              Help little kitty avoid obstacles and collect fish to improve
              their skills.
              <br />
              Design and development of the game are in progress.
              <br />
              In stores soon!
              <br />
              Text us in{" "}
        ...
        <div className="game">
          <div className="game-info">
            ...
            <p className="game-description">
              We have an idea for an app that will help you understand yourself
