...
export const metadata = {
  title: "Privacy Policy | Fluxo — Reptilians",
  description: "Privacy Policy for Fluxo by Reptilians",
}

export default function FluxoPrivacyPage() {
  return (
        ...
        <div className="container mx-auto max-w-3xl px-4 py-16 md:py-24">
          ...
          <div className="prose prose-neutral dark:prose-invert mt-12 max-w-none">
            ...
            <section className="mt-10 space-y-4">
              ...
              <p className="leading-relaxed text-muted-foreground">
                To exercise rights, contact us at <a href="mailto:hey@reptilians.studio" className="text-accent hover:underline">hey@reptilians.studio</a>.
            ...
            <section className="mt-10 space-y-4">
              ...
              <p className="leading-relaxed text-muted-foreground">
                Privacy questions or requests: <a href="mailto:hey@reptilians.studio" className="text-accent hover:underline">hey@reptilians.studio</a>
              </p>
            </section>
          </div>
        </div>
