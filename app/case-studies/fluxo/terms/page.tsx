...
export const metadata = {
  title: "Terms of Service | Fluxo — Reptilians",
  description: "Terms of Service for Fluxo by Reptilians",
}

export default function FluxoTermsPage() {
  return (
        ...
        <div className="container mx-auto max-w-3xl px-4 py-16 md:py-24">
          ...
          <div className="prose prose-neutral dark:prose-invert mt-12 max-w-none">
            ...
            <section className="mt-10 space-y-4">
              ...
              <p className="leading-relaxed text-muted-foreground">
                The Services may provide general information. <strong className="text-foreground">
            ...
            <section className="mt-10 space-y-4">
              ...
              <p className="leading-relaxed text-muted-foreground uppercase">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, THE SERVICES ARE PROVIDED <strong className="text-foreground">"AS IS"</strong> AND <strong className="text-foreground">"AS AVAILABLE"</strong> WITHOUT WARRANTIES OF ANY KIND,
            ...
            <section className="mt-10 space-y-4">
              ...
              <ul className="ml-6 list-disc space-y-2 text-muted-foreground">
                ...
                <li className="uppercase">
                  ...
                  PAID TO REPTILIANS FOR THE SERVICES IN THE <strong className="text-foreground">3 MONTHS</strong> BEFORE THE EVENT GIVING RISE TO THE CLAIM.
                </li>
              </ul>
              <p className="leading-relaxed text-muted-foreground">
            ...
            <section className="mt-10 space-y-4">
              ...
              <p className="leading-relaxed text-muted-foreground">
                Questions about these Terms: <a href="mailto:hey@reptilians.studio" className="text-accent hover:underline">hey@reptilians.studio</a>
              </p>
            </section>
          </div>
        </div>
